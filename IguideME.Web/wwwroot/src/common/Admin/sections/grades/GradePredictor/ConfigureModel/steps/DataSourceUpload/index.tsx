      ...
      <div>
        <Row>
          <Col xs={24} md={14}>
            ...
            <Alert message={"The models are trained on the data source from your local browser. This means that the" +
            " data source will never be uploaded to our service. Only the computed model states will be stored by" +
            " the application."} />
                ...
                <CSVReader
                  ...
                  onFileLoaded={(records) => {
                    if (!validateExternalUploadSchema(records)) {
                      message.error("Invalid data schema!");
                      return;
                    }
