...
import { Alert, Col, Divider, message, Row, Button, Select } from "antd";
...
export default class UploadData extends Component<IProps, IState> implements IStep {
    ...
    state = {
        gradesDatasets: (this._mock && this._mockGradesDatasets) ? this._gradesDatasetsMock : {},
        inputErrorFinalDS: false,
    }
            ...
            <Row>
                <Col xs={24} md={14}>
                    ...
                    <Row>
                        ...
                        <Col xs={24} md={12}>
                            <Select
                                className={"finalGradesDSSelect " + (this.state.inputErrorFinalDS && " error ")}
                                size="large"
