                ...
                <Row>
                    <Col xs={24} md={14}>
                        ...
                        {Object.keys(this.props.gradesDatasets)
                            .filter(databaseName => databaseName !== this.props.finalGradesDatasetName)
                            .map((datasetName) => (
                        ...
                        <Row>
                            <Col xs={24} md={24}>
                                ...
                                <p>
                                    ...
                                    assignment (e.g. mini-test, quiz, etc.); The files must contain
                                    the following two columns: "studentID" and "grade". Furthermore,
                                    please take note of which file contains the final grades.
              </p>
...
export class LinkLiveDataMock extends Mock {
    ...
    gradesDatasetTilePairs = this.enabled && this.mockGradesDatasetTilePairs ? JSON.parse('{"presentatie":2,"deeltoets3":4,"deeltoets2":7,"deeltoets1":1}') : {}
}
