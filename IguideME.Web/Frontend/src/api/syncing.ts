...
export const startNewSync: () => Promise<any> = async () =>
  await apiClient.post("datamart/start-sync", {});

export const stopCurrentSync: () => Promise<any> = async () =>
  await apiClient.post("datamart/stop-sync", {});
