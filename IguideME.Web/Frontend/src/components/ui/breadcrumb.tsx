...
function BreadcrumbSeparator({ children, className, ...props }: ComponentProps<'li'>): ReactElement {
  return (
...
function BreadcrumbEllipsis({ className, ...props }: ComponentProps<'span'>): ReactElement {
  return (
    <span
      role='presentation'
      aria-hidden='true'
