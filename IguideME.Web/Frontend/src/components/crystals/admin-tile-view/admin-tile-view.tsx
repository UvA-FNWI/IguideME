        ...
        <Col>
          <Space align="center">
            <Tooltip
              title={
                <>
                  This tile is {!tile.visible && <b>not </b>}visible for
                  students
                </>
              }
            >
            ...
            <h3 style={{ margin: "0 0 0 10px", paddingTop: 2 }}>
              {tile.title}
            </h3>
          </Space>
        </Col>
...
const TileTypeView: FC<{ tileType: TileType }> = ({
  tileType,
}): ReactElement => {
  switch (tileType) {
