      ...
      <Row align="middle" style={{ height: "3em" }}>
        ...
        <Col span={8}>
          <Item
            name="title"
            rules={[
              { required: true, message: "Please insert a title for the tile" },
            ]}
            noStyle
          >
...
const Notification: FC<{
  ...
  const [notifications, setNotifications] = useState<boolean | undefined>(
    value,
  );
...
const Visible: FC<{ value?: boolean; onChange?: (value: boolean) => void }> = ({
  value,
  onChange,
}): ReactElement => {
